...
export interface ContactSheetGrid { columns: number; rows: number }
...
export interface VideoProviderCapabilities {
  ...
  modes?: Array<"image-to-video" | "text-to-video" | "first-last-frame">;
...
export interface VideoProviderProfile {
  ...
  comfyui?: {
    ...
    workflowFormat?: "ui" | "api";
    bindings?: Partial<Record<"image" | "prompt" | "negativePrompt" | "width" | "height" | "frameCount" | "frameRate" | "seed" | "filenamePrefix", { nodeId: string; inputName: string }>>;
    outputNodeId?: string;
...
export interface VideoProviderSetup {
  id: string;
  requestId?: string;
...
export interface VideoProviderSetupInput {
  description: string;
  docsUrl?: string;
  baseUrl?: string;
  sampleRequest?: string;
